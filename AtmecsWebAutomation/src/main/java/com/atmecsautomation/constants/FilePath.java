...
public class FilePath {
	...
	public final static String LOCATOR_FILE= LOCATOR_HOME+"atmecslocators.properties";
	public final static String VALIDATION_FILE= RESOURCES_HOME+"testdata"+File.separator+"atmecs_automation_validatedata.xlsx";
